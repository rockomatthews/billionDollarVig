...
import { getUnitCount, type PlotRect } from "@/lib/board/geometry";
...
export function PurchasePanel({ selection, quote, creative }: PurchasePanelProps) {
    ...
    <div className="pixel-panel rounded-3xl p-4">
      ...
      <dl className="mb-4 grid grid-cols-2 gap-3 text-sm">
        <div className="rounded-2xl bg-black/30 p-3">
          ...
          <dd className="font-mono text-lg text-amber-50">{getUnitCount(selection).toLocaleString()}</dd>
        </div>
        <div className="rounded-2xl bg-black/30 p-3">
      ...
      <button
        ...
        disabled={!creativeReady || isSubmitting}
